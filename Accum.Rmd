...
### Function for benchmarking of all functions
```{r}
...
## Benchmark mkFrameForList, mkFrameList
...
## mkFrameInPlace, mkFrameDataTableFor
```{r}
...
## mkFrameDplyrBind, mkFramePlyrLdply, mkFrameMat, mkFrameVector, mkFrameDaccum
```{r}
# library('dplyr')
