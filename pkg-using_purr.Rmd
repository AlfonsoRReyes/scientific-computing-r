...
\[\Delta T = \Delta {T_0} \left[ 1 - \exp \left( { - \frac}} \right) \right] \]
...
\[\Delta T = \Delta {T_0}\left[ {\operatorname{erfc} \left( {\sqrt {\frac}} } \right) - \exp \left( {B{i_0} + \frac{4}\frac}} \right)\operatorname{erfc} \left( {\sqrt {\frac}}  + \frac}{2}\sqrt {\frac}} } \right)} \right]\]
