...
expect_true(planet@odeSolver@stepSize == 0.1)
expect_true(planet@odeSolver@numEqn == 0)

planet@odeSolver <- setStepSize(planet@odeSolver, 0.01)

expect_true(planet@odeSolver@stepSize == 0.01)

planet <- init(planet, state)
planet@state
expect_equal(planet@state, c(1, 0, 0, 6.28, 0))
planet@rate
```
...
planet@state == c(0,0,0,0,0)

planet@odeSolver@ode@state
planet@odeSolver@rate 
...
planet@odeSolver@numEqn == 0


planet@odeSolver@stepSize == 0.01
planet@odeSolver@numEqn == 0
planet@odeSolver@ode@state
```
...
for (i in 1:6) {
    ...
    cat("s[5]: ", planet@state[1], planet@state[2], planet@state[3], planet@state[4],"\n")
}
